    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <Link href="/dashboard/bookings" className="card transition-transform hover:-translate-y-1">
          ...
          <p className="mt-1 text-sm text-foreground/60">View your trips, payments, and receipts.</p>
        </Link>
        <Link href="/dashboard/profile" className="card transition-transform hover:-translate-y-1">
          ...
          <p className="mt-1 text-sm text-foreground/60">Update emergency contact and medical notes.</p>
        </Link>
        <Link href="/community" className="card transition-transform hover:-translate-y-1">
          ...
          <p className="mt-1 text-sm text-foreground/60">Share stories from the trail.</p>
        </Link>
        <Link href="/activities" className="card transition-transform hover:-translate-y-1">
          ...
          <p className="mt-1 text-sm text-foreground/60">Find your next adventure.</p>
        </Link>
      </div>
    </div>
  );
