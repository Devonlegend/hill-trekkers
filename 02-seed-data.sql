-- =========================================================
-- The Hill Trekkers Club — Seed Data
-- Run after 01-database-schema.sql
-- =========================================================

-- NOTE: replace the password_hash value with a real bcrypt hash before using
-- in anything beyond local development. This placeholder is NOT a valid hash.

INSERT INTO users (id, full_name, email, phone, password_hash, role, email_verified)
VALUES (
  gen_random_uuid(),
  'Club Admin',
  'admin@hilltrekkersclub.com',
  '+2348000000000',
...
-- price_kobo values above are in kobo: 1,500,000 kobo = ₦15,000, etc.
